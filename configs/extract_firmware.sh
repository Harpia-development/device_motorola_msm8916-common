...
for file in /firmware/image/*.gz; do
  ...
  gzip -dc $file > /system/system/vendor/firmware/$OUT_FILE
  gzip -dc $file > /system/system/etc/firmware/$OUT_FILE
  chmod 644 /system/system/vendor/firmware/$OUT_FILE
  chmod 644 /system/system/etc/firmware/$OUT_FILE
  chcon u:object_r:firmware_file:s0 /system/system/vendor/firmware/$OUT_FILE
