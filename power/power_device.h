...
static power_profile profiles[PROFILE_MAX] = {
    [PROFILE_POWER_SAVE] = {
        ...
        .timer_rate = 20000,
        .timer_rate_off = 40000,
        .above_hispeed_delay = 20000,
        .above_hispeed_delay_off = 40000,
        .target_loads = 90,
        .target_loads_off = 90,
        .scaling_max_freq = 998400,
        .scaling_max_freq_off = 998400,
    ...
    [PROFILE_HIGH_PERFORMANCE] = {
        ...
        .min_sample_time = 60000,
        .min_sample_time_off = 70000,
        .timer_rate = 20000,
        .timer_rate_off = 25000,
        .above_hispeed_delay = 20000,
        .above_hispeed_delay_off = 30000,
        .target_loads = 60,
        .target_loads_off = 65,
        .scaling_max_freq = 1363000,
        .scaling_max_freq_off = 1152000,
