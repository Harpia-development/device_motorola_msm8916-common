...
static void set_power_profile(int profile)
{
    ...
    sysfs_write_int(CPUFREQ_PATH "max_freq_hysteresis",
                    profiles[profile].max_freq_hysteresis);
    sysfs_write_int(CPUFREQ_PATH "timer_slack",
                    profiles[profile].timer_slack);
    sysfs_write_int(CPUFREQ_PATH "io_is_busy",
                    profiles[profile].io_is_busy);
    sysfs_write_int(CPUFREQ_PATH "align_windows",
                    profiles[profile].align_windows);
    sysfs_write_int(CPUFREQ_PATH "use_migration_notif",
                    profiles[profile].use_migration_notif);
    sysfs_write_int(CPUFREQ_PATH "use_sched_load",
